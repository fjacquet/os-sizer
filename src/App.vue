...
<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
    <header
      role="banner"
      class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-3 py-2 sm:px-6 sm:py-3 flex items-center justify-between sticky top-0 z-10 print:hidden"
    >
