...
<template>
  <button
    ...
    :title="ui.isDarkMode ? 'Switch to light mode' : 'Switch to dark mode'"
    class="rounded p-1.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
    @click="ui.setDarkMode(!ui.isDarkMode)"
  >
    <!-- Sun icon (shown in dark mode to switch to light) -->
    <svg v-if="ui.isDarkMode" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true">
