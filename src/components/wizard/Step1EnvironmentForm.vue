...
<template>
  ...
  >
    ...
    <!-- Environment type -->
    <div class="space-y-2">
      <label id="env-type-label" class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
        t('environment.label')
      }}</label>
      <div
    ...
    <!-- Connectivity -->
    <div class="space-y-2">
      <label id="connectivity-label" class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
        t('environment.connectivity')
      }}</label>
      <div
        class="flex gap-2"
        role="radiogroup"
    ...
    <!-- HA Level -->
    <div class="space-y-2">
      <label id="ha-level-label" class="text-sm font-medium text-gray-700 dark:text-gray-300">{{
        t('environment.haLevel')
      }}</label>
      <div
        class="flex gap-2"
        role="radiogroup"
