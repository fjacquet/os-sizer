<script setup lang="ts">
  ...
  import type { TopologyType, SnoProfile, ClusterConfig, VirtConfig } from '@/engine/types'
  ...
  // Virtualization mode: topology is engine-irrelevant — surface storage choice and auto-confirm.
  ...
  function setStorage(b: VirtConfig['storageBackend']) {
    ...
    if (c)
      input.updateCluster(c.id, {
        virt: { ...(c.virt ?? createDefaultVirtConfig()), storageBackend: b },
      })
  }
