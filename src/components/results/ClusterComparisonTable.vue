...
<template>
  <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
    <table class="w-full text-sm border-collapse" :aria-label="t('results.clusters.compareTitle')">
      <caption
        class="text-left text-base font-semibold text-gray-900 dark:text-gray-100 mb-2 px-3 pt-3"
      >
        {{
      ...
      <thead class="bg-gray-50 dark:bg-gray-700">
        <tr>
          ...
          <th
            class="px-3 py-2 text-left font-medium text-gray-600 dark:text-gray-300 border-b border-gray-200 dark:border-gray-600 min-w-36"
          >
