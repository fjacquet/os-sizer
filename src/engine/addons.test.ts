...
import { MIG_PROFILES, RHOAI_WORKER_MIN_VCPU, RHOAI_WORKER_MIN_RAM_GB } from './constants'
...
describe('calcRHOAI', () => {
  ...
  it('lifts worker vcpu below floor to RHOAI_WORKER_MIN_VCPU (8)', () => {
    const sizing = {
      masterNodes: { count: 3, vcpu: 8, ramGB: 32, storageGB: 100 },
      workerNodes: { ...baseWorker },
      infraNodes: null,
      odfNodes: null,
      rhacmWorkers: null,
  ...
  it('does not lower worker vcpu above minimum (32 vCPU / 64 GB)', () => {
    const sizing = {
      masterNodes: { count: 3, vcpu: 8, ramGB: 32, storageGB: 100 },
      workerNodes: { count: 3, vcpu: 32, ramGB: 64, storageGB: 100 },
      infraNodes: null,
      odfNodes: null,
      rhacmWorkers: null,
      virtWorkerNodes: null,
