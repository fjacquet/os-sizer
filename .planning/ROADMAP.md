...
**Plans**: 3 plans
Plans:
- [ ] 10-01-PLAN.md — Type Extension + GPU Constants (AddOnConfig GPU fields, MIG_PROFILES lookup, GPU_NODE_MIN_*, defaults, useUrlState schema)
...
| 10. GPU Node Engine | v2.0 | 0/3 | Not started | — |
