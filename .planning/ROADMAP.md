...
- ✅ **v1.0 — Full OpenShift Sizer** — Phases 1-8 (shipped 2026-04-01) → [archive](milestones/v1.0-ROADMAP.md)
- ✅ **v2.0 — OpenShift Virtualization + AI Sizing** — Phases 9-12 (shipped 2026-04-04) → [archive](milestones/v2.0-ROADMAP.md)
- ✅ **v2.1 — Export** — Phases 13-19 (shipped 2026-04-06) → [archive](milestones/v2.1-ROADMAP.md)
...
<details>
<summary>✅ v2.1 — Export (Phases 13-19) — SHIPPED 2026-04-06</summary>

- [x] Phase 13: Foundation Infrastructure (2/2 plans) — completed 2026-04-05
- [x] Phase 14: Warning Fix (1/1 plan) — completed 2026-04-05
- [x] Phase 15: Session Portability (2/2 plans) — completed 2026-04-05
- [x] Phase 16: PPTX Redesign (2/2 plans) — completed 2026-04-05
- [x] Phase 17: PDF Redesign (2/2 plans) — completed 2026-04-05
- [x] Phase 18: Multi-Cluster UI (2/2 plans) — completed 2026-04-06
- [x] Phase 19: Aggregate Exports (2/2 plans) — completed 2026-04-06
...
| 16. PPTX Redesign | v2.1 | 2/2 | Complete | 2026-04-05 |
