...
- [x] **Phase 12: BoM, Exports, Wizard UI + i18n** - GPU and RHOAI rows in BoM/exports; wizard inputs for all new fields; all four locales (completed 2026-04-04)
...
- [x] 12-05-PLAN.md — Component tests: export composables + BomTable v2.0 row coverage (Wave 4)
**UI hint**: yes
